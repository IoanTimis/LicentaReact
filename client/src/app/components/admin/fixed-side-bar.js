...
import { HomeIcon, UsersIcon, AcademicCapIcon, ArrowRightOnRectangleIcon, BuildingOffice2Icon, BuildingOfficeIcon } from "@heroicons/react/24/solid";
  ...
  return (
    <div className="fixed top-0 left-0 h-full w-64 bg-gray-900 text-white flex flex-col p-6 shadow-lg">
      ...
      <nav className="flex flex-col space-y-4">
        ...
        <Link href="/admin/teachers" className="flex items-center space-x-2 p-3 rounded-lg hover:bg-gray-700">
          <AcademicCapIcon className="h-5 w-5" />
          <span>Profesori</span>
        </Link>
        <Link href="/admin/faculties" className="flex items-center space-x-2 p-3 rounded-lg hover:bg-gray-700">
          <BuildingOffice2Icon className="h-5 w-5" />
          <span>Facultăți</span>
        </Link>
        <Link href="/admin/specializations" className="flex items-center space-x-2 p-3 rounded-lg hover:bg-gray-700">
